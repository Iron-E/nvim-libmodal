...
function Layer.new(keymappings)
   ...
   for --[[mode]] _, keymaps in pairs(keymappings) do
      for lhs, map in pairs(keymaps) do
         -- For backward compability convert from
...
-- }
--
-- local test_layer = Layer.new(test_keymappings)
-- print(test_layer)
--
-- test_layer:enter()
--
...
--
-- local exit_char = '<Esc>'
-- test_layer:map('n', exit_char, function() test_layer:exit() end)
--
-- print(test_layer)
--
-- -- test_layer:exit()
